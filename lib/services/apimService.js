        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, this.apimClient.api.createOrUpdate(this.resourceGroup, this.apimConfig.name, apiContract.name, __assign(__assign({}, apiContract), { isCurrent: true }))];
                    case 2:
                        api = _a.sent();
