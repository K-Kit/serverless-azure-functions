...
var ConfigService = /** @class */ (function () {
    ...
    ConfigService.prototype.initializeConfig = function (service) {
        ...
        config.provider = __assign(__assign({}, config.provider), { prefix: this.getOption("prefix") || prefix, stage: this.getOption("stage") || stage, region: this.getOption("region") || region, subscriptionId: this.getOption(constants_1.constants.variableKeys.subscriptionId)
                || process.env.AZURE_SUBSCRIPTION_ID
                || subscriptionId
        ...
        config.provider.deployment = __assign(__assign({}, constants_1.constants.deploymentConfig), deployment);
