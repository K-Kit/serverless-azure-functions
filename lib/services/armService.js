...
var ArmService = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        if (this.config.provider.apim) {
                            ...
                            mergedTemplate.parameters = __assign(__assign({}, mergedTemplate.parameters), apimTemplate.parameters);
                            mergedTemplate.resources = __spread(mergedTemplate.resources, apimTemplate.resources);
                            parameters = __assign(__assign({}, parameters), apimParameters);
                        }
                        return [2 /*return*/, {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        armDeployment = {
                            properties: __assign(__assign({}, deployment), { mode: "Incremental" })
                        };
                        // Deploy ARM template
    ...
    ArmService.prototype.areDeploymentsEqual = function (current, previous) {
        ...
        var templateNormalizer = function (template) {
            return __assign(__assign({}, template), { resources: template.resources.map(function (item) {
        ...
        var paramsNormalizer = function (params) {
            ...
            try {
                for (var keys_1 = __values(keys), keys_1_1 = keys_1.next(); !keys_1_1.done; keys_1_1 = keys_1.next()) {
                    ...
                    normalized[key] = __assign(__assign({}, original), { type: original.type.toLowerCase() });
                }
            }
