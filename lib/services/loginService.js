...
exports.AzureLoginService = void 0;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, ms_rest_nodeauth_1.interactiveLoginWithAuthResponse(__assign(__assign({}, options), { tokenCache: fileTokenCache }))];
                    case 2:
                        authResp = _a.sent();
