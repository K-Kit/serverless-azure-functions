...
var PackageService = /** @class */ (function (_super) {
    ...
    PackageService.prototype.createBindings = function (offlineMode) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        createEventsPromises = this.serverless.service
                            .getAllFunctions()
    ...
    PackageService.prototype.cleanUp = function () {
        var e_1, _a, e_2, _b;
        var functionFilesToRemove = ["function.json"];
        var functionFoldersToRemove = ["__pycache__"];
        var rootFilesToRemove = [".funcignore"];
        var rootFoldersToRemove = [constants_1.constants.tmpBuildDir, "bin", "obj"];
    ...
    PackageService.prototype.getFunctionJson = function (functionName, functionMetadata) {
        ...
        if (this.configService.isPythonTarget()) {
            var index = functionJSON.bindings.findIndex(function (binding) { return !binding.direction || binding.direction === "out"; });
            if (functionJSON.bindings[index]) {
                functionJSON.bindings[index].name = "$return";
            }
        }
        // @todo make this dynamic
        functionJSON.scriptFile = "../" + this.configService.options.out + "/service/" + handlerPath.replace("../", "");
        ...
        if (bindingAzureSettings.route) {
            ...
            var index = functionJSON.bindings.findIndex(function (binding) { return !binding.direction || binding.direction === "in"; });
            if (functionJSON.bindings[index]) {
