...
exports.FunctionAppService = void 0;
...
var FunctionAppService = /** @class */ (function (_super) {
    ...
    FunctionAppService.prototype.uploadZippedArtifactToFunctionApp = function (functionApp, functionZipFile) {
        return __awaiter(this, void 0, void 0, function () {
            var scmDomain, isLinux, uri, requestOptions, _a;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        requestOptions = (_b.headers = (_c.Authorization = _a + (_d.sent()),
                            _c.Accept = "*/*",
                            _c.ContentType = "application/octet-stream",
                            _c["User-Agent"] = "serverless_framework/" + this.serverless.version + " serverless_azure_functions/" + packageJson.version,
                            _c),
                            _b);
