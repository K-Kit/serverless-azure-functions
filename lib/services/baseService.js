...
var BaseService = /** @class */ (function () {
    ...
    BaseService.prototype.sendApiRequest = function (method, relativeUrl, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var defaultHeaders, _a, allHeaders, requestOptions;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        defaultHeaders = (_b.Authorization = _a + (_c.sent()),
                            _b);
                        allHeaders = __assign(__assign({}, defaultHeaders), options.headers);
                        requestOptions = __assign(__assign({}, options), { method: method, headers: allHeaders });
