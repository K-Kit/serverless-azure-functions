...
var AppServiceEnvironmentTemplate = /** @class */ (function (_super) {
    ...
    AppServiceEnvironmentTemplate.prototype.getTemplate = function (config) {
        ...
        if (appServicePlan) {
            ...
            appServicePlan.properties.hostingEnvironmentProfile = __assign(__assign({}, appServicePlan.properties.hostingEnvironmentProfile), { id: "[resourceId('Microsoft.Web/hostingEnvironments', parameters('hostingEnvironmentName'))]" });
        }
        ...
        if (app) {
            ...
            app.properties.hostingEnvironmentProfile = __assign(__assign({}, app.properties.hostingEnvironmentProfile), { id: "[resourceId('Microsoft.Web/hostingEnvironments', parameters('hostingEnvironmentName'))]" });
        }
        return template;
    };
