...
exports.CompositeArmTemplate = void 0;
...
var CompositeArmTemplate = /** @class */ (function () {
    ...
    CompositeArmTemplate.prototype.getTemplate = function (config) {
        ...
        this.childTemplates.forEach(function (resource) {
            ...
            template.parameters = __assign(__assign({}, template.parameters), resourceTemplate.parameters);
    ...
    CompositeArmTemplate.prototype.getParameters = function (config) {
        var parameters = {};
        this.childTemplates.forEach(function (resource) {
            parameters = __assign(__assign(__assign({}, parameters), resource.getParameters(config)), { location: {
