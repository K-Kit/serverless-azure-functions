...
exports.FunctionAppResource = void 0;
...
var FunctionAppResource = /** @class */ (function () {
    ...
    FunctionAppResource.prototype.getFunctionAppSettings = function (config) {
        var appInsights = config.provider.appInsights;
        var instrumentationKey = appInsights ? appInsights.instrumentationKey : undefined;
        var appSettings = [
            {
