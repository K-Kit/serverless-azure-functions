...
exports.StorageAccountResource = void 0;
...
var StorageAccountResource = /** @class */ (function () {
    ...
    StorageAccountResource.getResourceName = function (config) {
        ...
        return namingService_1.AzureNamingService.getSafeResourceName(__assign(__assign({}, options), { maxLength: constants_1.constants.naming.maxLength.storageAccount }));
    };
