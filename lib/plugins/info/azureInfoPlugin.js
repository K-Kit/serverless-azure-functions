...
exports.AzureInfoPlugin = void 0;
var azureBasePlugin_1 = require("../azureBasePlugin");
var constants_1 = require("../../shared/constants");
var infoService_1 = require("../../services/infoService");
var AzureInfoPlugin = /** @class */ (function (_super) {
    __extends(AzureInfoPlugin, _super);
    function AzureInfoPlugin(serverless, options) {
        var _this = _super.call(this, serverless, options) || this;
        _this.hooks = {
            "info:info": _this.executeInfo.bind(_this)
        };
        _this.commands = {
            info: {
                ...
                options: __assign(__assign({}, constants_1.constants.deployedServiceOptions), { dryrun: {
    ...
    AzureInfoPlugin.prototype.executeInfo = function () {
        return __awaiter(this, void 0, void 0, function () {
            var infoService, infoType;
            return __generator(this, function (_a) {
                infoService = new infoService_1.AzureInfoService(this.serverless, this.options);
                infoType = "dryrun" in this.options ? infoService_1.ServiceInfoType.DRYRUN : infoService_1.ServiceInfoType.DEPLOYED;
                infoService.printInfo(infoType);
                return [2 /*return*/];
            });
        });
    };
    return AzureInfoPlugin;
}(azureBasePlugin_1.AzureBasePlugin));
exports.AzureInfoPlugin = AzureInfoPlugin;
