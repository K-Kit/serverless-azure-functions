...
exports.AzureApimPlugin = void 0;
var apimService_1 = require("../../services/apimService");
var azureBasePlugin_1 = require("../azureBasePlugin");
var AzureApimPlugin = /** @class */ (function (_super) {
    __extends(AzureApimPlugin, _super);
    function AzureApimPlugin(serverless, options) {
        var _this = _super.call(this, serverless, options) || this;
        _this.hooks = {
            "after:deploy:deploy": _this.deploy.bind(_this),
        };
        return _this;
    }
    AzureApimPlugin.prototype.deploy = function () {
    ...
    return AzureApimPlugin;
}(azureBasePlugin_1.AzureBasePlugin));
exports.AzureApimPlugin = AzureApimPlugin;
